...
# #创建训练集
train_datasets = MyDataSet('data/NSL-KDD/training_attack_types.txt',"data/NSL-KDD/KDDTrain+_11_1.txt")
...
if __name__ == '__main__':
    ...
    try:
        ...
        app = TrainWindow(master=root,socket = Socket_tcp,model=model,
                train_datasets=train_datasets,test_datasets=test_datasets,args=args,TP=TP,name="1")
        root.mainloop()
    finally:
        Socket_tcp.close()